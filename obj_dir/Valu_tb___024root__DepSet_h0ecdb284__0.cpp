...
VL_INLINE_OPT VlCoroutine Valu_tb___024root___eval_initial__TOP__Vtiming__0(Valu_tb___024root* vlSelf) {
    ...
    vlSelfRef.alu_tb__DOT__alu_control = 0U;
    co_await vlSelfRef.__VdlySched.delay(0xaULL, nullptr, 
                                         "tb/alu_tb.sv", 
                                         25);
    VL_WRITEF_NX("ADD Result = %0#\n",0,32,vlSelfRef.alu_tb__DOT__result);
    vlSelfRef.alu_tb__DOT__alu_control = 1U;
    co_await vlSelfRef.__VdlySched.delay(0xaULL, nullptr, 
                                         "tb/alu_tb.sv", 
                                         30);
    VL_WRITEF_NX("SUB Result = %0#\n",0,32,vlSelfRef.alu_tb__DOT__result);
    vlSelfRef.alu_tb__DOT__alu_control = 2U;
    co_await vlSelfRef.__VdlySched.delay(0xaULL, nullptr, 
                                         "tb/alu_tb.sv", 
                                         35);
    VL_WRITEF_NX("AND Result = %0#\n",0,32,vlSelfRef.alu_tb__DOT__result);
    vlSelfRef.alu_tb__DOT__alu_control = 3U;
    co_await vlSelfRef.__VdlySched.delay(0xaULL, nullptr, 
                                         "tb/alu_tb.sv", 
                                         40);
    VL_WRITEF_NX("OR Result = %0#\n",0,32,vlSelfRef.alu_tb__DOT__result);
    VL_FINISH_MT("tb/alu_tb.sv", 43, "");
}
...
VL_INLINE_OPT void Valu_tb___024root___act_sequent__TOP__0(Valu_tb___024root* vlSelf) {
    ...
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelfRef.alu_tb__DOT__result = ((4U & (IData)(vlSelfRef.alu_tb__DOT__alu_control))
                                      ? 0U : ((2U & (IData)(vlSelfRef.alu_tb__DOT__alu_control))
                                               ? ((1U 
                                                   & (IData)(vlSelfRef.alu_tb__DOT__alu_control))
                                                   ? 
