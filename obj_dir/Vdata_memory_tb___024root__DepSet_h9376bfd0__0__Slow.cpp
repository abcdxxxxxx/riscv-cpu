...
#endif
            VL_FATAL_MT("tb/data_memory_tb.sv", 1, "", "Settle region did not converge.");
        }
...
VL_ATTR_COLD void Vdata_memory_tb___024root___ctor_var_reset(Vdata_memory_tb___024root* vlSelf) {
    ...
    vlSelf->data_memory_tb__DOT__mem_write = VL_RAND_RESET_I(1);
    vlSelf->data_memory_tb__DOT__mem_read = VL_RAND_RESET_I(1);
    vlSelf->data_memory_tb__DOT__addr = VL_RAND_RESET_I(32);
    vlSelf->data_memory_tb__DOT__write_data = VL_RAND_RESET_I(32);
    vlSelf->data_memory_tb__DOT__read_data = VL_RAND_RESET_I(32);
    for (int __Vi0 = 0; __Vi0 < 256; ++__Vi0) {
        vlSelf->data_memory_tb__DOT__dut__DOT__mem[__Vi0] = VL_RAND_RESET_I(32);
    }
