...
VL_INLINE_OPT VlCoroutine Vdata_memory_tb___024root___eval_initial__TOP__Vtiming__0(Vdata_memory_tb___024root* vlSelf) {
    ...
    vlSelfRef.data_memory_tb__DOT__mem_write = 1U;
    vlSelfRef.data_memory_tb__DOT__mem_read = 0U;
    vlSelfRef.data_memory_tb__DOT__addr = 0U;
    vlSelfRef.data_memory_tb__DOT__write_data = 0x19U;
    co_await vlSelfRef.__VdlySched.delay(0xaULL, nullptr, 
                                         "tb/data_memory_tb.sv", 
                                         47);
    vlSelfRef.data_memory_tb__DOT__mem_write = 0U;
    vlSelfRef.data_memory_tb__DOT__mem_read = 1U;
    co_await vlSelfRef.__VdlySched.delay(0xaULL, nullptr, 
                                         "tb/data_memory_tb.sv", 
                                         54);
    VL_WRITEF_NX("Memory Read = %0#\n",0,32,vlSelfRef.data_memory_tb__DOT__read_data);
    VL_FINISH_MT("tb/data_memory_tb.sv", 59, "");
}
...
void Vdata_memory_tb___024root___act_sequent__TOP__0(Vdata_memory_tb___024root* vlSelf);
...
void Vdata_memory_tb___024root___eval_act(Vdata_memory_tb___024root* vlSelf) {
    ...
    if ((2ULL & vlSelfRef.__VactTriggered.word(0U))) {
        Vdata_memory_tb___024root___act_sequent__TOP__0(vlSelf);
    }
}

VL_INLINE_OPT void Vdata_memory_tb___024root___act_sequent__TOP__0(Vdata_memory_tb___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vdata_memory_tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vdata_memory_tb___024root___act_sequent__TOP__0\n"); );
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelfRef.data_memory_tb__DOT__read_data = ((IData)(vlSelfRef.data_memory_tb__DOT__mem_read)
                                                 ? 
                                                vlSelfRef.data_memory_tb__DOT__dut__DOT__mem
                                                [(0xffU 
                                                  & (vlSelfRef.data_memory_tb__DOT__addr 
                                                     >> 2U))]
                                                 : 0U);
}
...
VL_INLINE_OPT void Vdata_memory_tb___024root___nba_sequent__TOP__0(Vdata_memory_tb___024root* vlSelf) {
    ...
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Init
    IData/*31:0*/ __VdlyVal__data_memory_tb__DOT__dut__DOT__mem__v0;
    __VdlyVal__data_memory_tb__DOT__dut__DOT__mem__v0 = 0;
    CData/*7:0*/ __VdlyDim0__data_memory_tb__DOT__dut__DOT__mem__v0;
    __VdlyDim0__data_memory_tb__DOT__dut__DOT__mem__v0 = 0;
    CData/*0:0*/ __VdlySet__data_memory_tb__DOT__dut__DOT__mem__v0;
    __VdlySet__data_memory_tb__DOT__dut__DOT__mem__v0 = 0;
    // Body
    __VdlySet__data_memory_tb__DOT__dut__DOT__mem__v0 = 0U;
    if (vlSelfRef.data_memory_tb__DOT__mem_write) {
        __VdlyVal__data_memory_tb__DOT__dut__DOT__mem__v0 
            = vlSelfRef.data_memory_tb__DOT__write_data;
        __VdlyDim0__data_memory_tb__DOT__dut__DOT__mem__v0 
            = (0xffU & (vlSelfRef.data_memory_tb__DOT__addr 
                        >> 2U));
        __VdlySet__data_memory_tb__DOT__dut__DOT__mem__v0 = 1U;
    }
    if (__VdlySet__data_memory_tb__DOT__dut__DOT__mem__v0) {
        vlSelfRef.data_memory_tb__DOT__dut__DOT__mem[__VdlyDim0__data_memory_tb__DOT__dut__DOT__mem__v0] 
            = __VdlyVal__data_memory_tb__DOT__dut__DOT__mem__v0;
    }
}
...
#endif
            VL_FATAL_MT("tb/data_memory_tb.sv", 1, "", "NBA region did not converge.");
        }
...
#endif
                VL_FATAL_MT("tb/data_memory_tb.sv", 1, "", "Active region did not converge.");
            }
